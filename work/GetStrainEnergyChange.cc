...
static double getDistance(const std::shared_ptr<Node>& node1,
...
static Eigen::Vector2d getNormal(const std::shared_ptr<Node>& node1,
                                 const std::shared_ptr<Node>& node2) {
...
static Eigen::Vector2d getTraction(const std::shared_ptr<Node>& node1,
                                   const std::shared_ptr<Node>& node2) {
...
static Eigen::Vector2d getDisplacement(const std::shared_ptr<Node>& node1,
                                       const std::shared_ptr<Node>& node2,
